...
const _env = createEnv({
    ...
    runtimeEnv: {
        ...
        FB_APP_ID: process.env.FB_APP_SECRET ? process.env.NEXT_PUBLIC_FB_APP_ID : null,
        FB_APP_SECRET: process.env.FB_APP_SECRET,
        APP_SECRET: process.env.APP_SECRET,

        NEXT_PUBLIC_FB_APP_ID: process.env.FB_APP_SECRET ? process.env.NEXT_PUBLIC_FB_APP_ID : null,
